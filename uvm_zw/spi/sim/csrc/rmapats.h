...
void  rmaPropagate13_p_spi_simv_daidir (UB  * pcode, scalar  val);
void  rmaPropagate13_spi_simv_daidir (UB  * pcode, scalar  val);
void  rmaPropagate13_f_spi_simv_daidir (UB  * pcode, scalar  val, U  I615, scalar  * I1485, U  did);
void  rmaPropagate13_r_spi_simv_daidir (UB  * pcode);
void  rmaPropagate13_wn_spi_simv_daidir (UB  * pcode, scalar  val);
